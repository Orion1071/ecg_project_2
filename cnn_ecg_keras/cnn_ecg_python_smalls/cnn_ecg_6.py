...
df.head()
df.to_csv('/scratch/thurasx/ecg_project_2/cnn_ecg_keras/history_small_6.csv')

# model.save('/scratch/thurasx/ecg_project_2/cnn_ecg_keras/cnn_ecg_keras_full.h5')
converter = tf.lite.TFLiteConverter.from_keras_model(model)
tflite_model = converter.convert()

with open('/scratch/thurasx/ecg_project_2/cnn_ecg_keras/cnn_ecg_keras_tflites/keras_ecg_cnn_small_6.tflite', 'wb+') as f:

...
model.add(layers.MaxPool2D(100,100))
...
df.head()
df.to_csv('/scratch/thurasx/ecg_project_2/cnn_ecg_keras/history_small_4.csv')

model.save('/scratch/thurasx/ecg_project_2/cnn_ecg_keras/cnn_ecg_keras_small_4.h5')